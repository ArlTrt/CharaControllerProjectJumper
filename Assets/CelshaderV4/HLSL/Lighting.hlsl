...
void AddAdditionalLights_float(float Smoothness, float3 WorldPosistion, float3 WorldNormal, float3 WorldView,
...
out float Diffuse, out float Specular, out float3 Color)
{
    ...
    {
        Light light = GetAdditionalLight(i, WorldPosistion);
    ...
    //If no lights touches this pixel, set the color to the main light color
